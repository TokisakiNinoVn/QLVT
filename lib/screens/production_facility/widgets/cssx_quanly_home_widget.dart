...
class CSSXQuanLyScreen extends StatelessWidget {
  const CSSXQuanLyScreen({super.key});

  // Grouped menu items into logical categories
  final List<_MenuCategory> menuCategories = const [
    ...
    _MenuCategory(
      ...
      items: [
        ...
        _MenuItem(id: 6, title: 'Quản lý chế biến', icon: Icons.history),
      ],
    ),
    _MenuCategory(
