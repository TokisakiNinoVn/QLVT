...
class _HarvestPackagingCreateScreenState
    extends State<HarvestPackagingCreateScreen> {
  ...
  Future<void> _createHarvestPackaging() async {
    ...
    try {
      ...
      final response = await _harvestpackagingService
          .createHarvestPackagingService(data);
      ...
      print("Lỗi khi tạo đóng gói mới: $e");
    } finally {
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildTextField(
                          ...
                          enabled:
                              widget.code ==
                              null, // Disable if code is provided
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Vui lòng nhập mã đóng gói';
                            }
                            return null;
                          },
                        ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items:
                              _plantingAreas.map<DropdownMenuItem<String>>((
                                ...
                                return DropdownMenuItem<String>(
                                  value:
                                      area['id']
                                          .toString(), // Chuyển id thành String
                                  child: Text(
                          ...
                          onChanged: (value) {
                            ...
                            // Bạn có thể xử lý thêm logic khi chọn vùng trồng tại đây
                          },
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed:
                                _isLoading ? null : _createHarvestPackaging,
