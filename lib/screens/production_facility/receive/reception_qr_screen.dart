...
class ScanQRReceptionScreen extends StatefulWidget {
  const ScanQRReceptionScreen({super.key});

  @override
  State<ScanQRReceptionScreen> createState() => _ScanQRScreenState();
}

class _ScanQRScreenState extends State<ScanQRReceptionScreen> {
    ...
    try {
      ...
      if (value != null && mounted) {
        ...
        if (code.isNotEmpty && mounted) {
          ...
          context.go('/reception-management/create-reception/$code');
        } else if (mounted) {
          ScaffoldMessenger.of(
            context,
            ...
            child: Column(
              children: [
                if (_isProcessing)
                  ...
                  const Text(
                    'Đưa mã QR đơn vận vào vùng quét',
