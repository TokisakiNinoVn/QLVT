...
class AdditiveProductsCreateScreen extends StatefulWidget {
  const AdditiveProductsCreateScreen({super.key});

  @override
  State<AdditiveProductsCreateScreen> createState() =>
      _AdditiveProductsCreateScreenState();
}

class _AdditiveProductsCreateScreenState
    extends State<AdditiveProductsCreateScreen> {
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  decoration: InputDecoration(
                    labelText: 'Chọn Quy trình chế biến',
                  ...
                  value: _selectedProductionProcessId,
                  onChanged: (value) {
                          ...
                          : () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                context.go("/additive-products-management");
