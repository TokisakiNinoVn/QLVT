...
class ScanQRCSSXScreen extends StatefulWidget {
  const ScanQRCSSXScreen({super.key});

  @override
  State<ScanQRCSSXScreen> createState() => _ScanQRScreenState();
}

class _ScanQRScreenState extends State<ScanQRCSSXScreen> {
    ...
    try {
      ...
      if (value != null && mounted) {
        ...
        if (code.isNotEmpty && mounted) {
          context.push('/processing-management/processing-history-create/$code');
        } else if (mounted) {
          ScaffoldMessenger.of(
            context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Thêm lịch sử chế biến cho lô hàng')),
      body: Stack(
        children: [
          MobileScanner(
