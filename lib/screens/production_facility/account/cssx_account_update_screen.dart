...
class CSSXAccountUpdateScreen extends StatefulWidget {
  final int id;
  const CSSXAccountUpdateScreen({super.key, required this.id});

  @override
  State<CSSXAccountUpdateScreen> createState() => _AccountUpdateScreenState();
}

class _AccountUpdateScreenState extends State<CSSXAccountUpdateScreen> {
  ...
  Future<void> _pickAvatar() async {
    try {
      ...
      setState(() {
        ...
        _networkAvatarUrl = null; // clear network avatar when choosing new one
      });
    } catch (e) {
      if (mounted) {
  ...
  Future<void> _loadAccountDetails(int id) async {
    try {
      ...
      final data = response["data"]?["taikhoansanxuat"];
