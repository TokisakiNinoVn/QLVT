...
class CSSXAccountCreateScreen extends StatefulWidget {
  const CSSXAccountCreateScreen({super.key});

  @override
  State<CSSXAccountCreateScreen> createState() => _AccountCreateScreenState();
}

class _AccountCreateScreenState extends State<CSSXAccountCreateScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Tạo tài khoản CSSX',
          // style: TextStyle(fontWeight: color: Colors.white),
        ),
                          ...
                          : () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                context.go("/cssx-account-management");
