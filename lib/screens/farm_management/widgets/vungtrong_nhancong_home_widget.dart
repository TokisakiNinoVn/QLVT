...
class VungTrongNhanCongScreen extends StatelessWidget {
  const VungTrongNhanCongScreen({super.key});
  ...
  final List<_MenuCategory> menuCategories = const [
    ...
    _MenuCategory(
      ...
      items: [
        _MenuItem(
          id: 1,
          title: 'Quét QR thêm lịch sử chăm sóc vùng trồng',
          icon: Icons.qr_code_scanner,
        ),
        // _MenuItem(
        //   id: 3,
        //   title: 'Quản lý tài khoản vùng trồng',
        ...
        // ),
        // _MenuItem(id: 5, title: 'Phân bón - thuốc', icon: Icons.medication),
      ],
    ),
    // _MenuCategory(
    //   title: 'Hậu Cần',
