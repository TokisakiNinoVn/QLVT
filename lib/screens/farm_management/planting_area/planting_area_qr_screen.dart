...
class ScanQRDetailsVTScreen extends StatefulWidget {
  const ScanQRDetailsVTScreen({super.key});

  @override
  State<ScanQRDetailsVTScreen> createState() => _ScanQRScreenState();
}

class _ScanQRScreenState extends State<ScanQRDetailsVTScreen> {
    ...
    try {
      ...
      if (value != null && mounted) {
        ...
        if (code.isNotEmpty && mounted) {
          context.push(
            '/planting-area-management/details-tv-qr/$code',
          );
        } else if (mounted) {
          ScaffoldMessenger.of(
            context,
