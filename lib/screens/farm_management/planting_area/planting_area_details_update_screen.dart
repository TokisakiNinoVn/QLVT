...
class PlantingAreaDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> plantingArea;

  const PlantingAreaDetailsScreen({super.key, required this.plantingArea});

  @override
  State<PlantingAreaDetailsScreen> createState() =>
      _PlantingAreaDetailsScreenState();
}

class _PlantingAreaDetailsScreenState extends State<PlantingAreaDetailsScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          OutlinedButton.icon(
            ...
            label: Text("Chọn ảnh vùng trồng",
            style: TextStyle(
              color: ColorConfig.primary
            ),),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(_isEditMode ? Icons.visibility : Icons.edit, color: Colors.white),
            ...
            style: IconButton.styleFrom(
              backgroundColor: _isEditMode ? ColorConfig.primary : Colors.green,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(8),
              ),
            ),
