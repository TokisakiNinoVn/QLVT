...
class _AccountManagementScreenState extends State<AccountManagementScreen> {
  ...
  Future<void> _loadAccounts() async {
    try {
      ...
      final rawData = response["data"]?["taikhoanvungtrongs"]?["data"];
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () =>    context.push('/account-management/account-create'),
          ...
          Expanded(
            child: _isLoading
              ...
              itemBuilder: (context, index) {
                ...
                final isManager = account["quyenhan"] == 'quanly';
                      ...
                      child: Row(
                        children: [
                          ...
                          CircleAvatar(
                            radius: 32,
                            backgroundImage:
                            NetworkImage(_checkAvatarLink(account["avatar"])),
